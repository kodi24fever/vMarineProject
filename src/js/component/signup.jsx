...
export default class SignUp extends React.Component{
 ...
 render() {
    return (
        <Consumer>
            {({state, actions}) => {
                const status = state.formsResponseStatus;
                            ...
                            <div className="container mx-auto">
                                ...
                                <form onSubmit={(e) => {e.preventDefault(); 
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="firstname" className="form-control" value={this.state.firstName} onChange={(e) => this.setState({firstName: e.target.value})}/>
                                    </div>
                                    <div className="form-group">
                                        <label>Last Name</label>
                                        <input type="lastname" className="form-control" value={this.state.lastName} onChange={(e) => this.setState({lastName: e.target.value})}/>
                                    </div>
                                    <div className="form-group">
                                        <label>Email</label>
                ...
                if(status === 200) return <Redirect to='/userpage'  />;
